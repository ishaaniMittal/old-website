    ...
    window.HexaFlip = (function () {
        ...
        function HexaFlip(el, sets, options) {
            ...
            if (!this.sets) {
                ...
                this.sets = {
                    hour: ['', 'Res', 'Pro', 'De', 'Inn', 'Ath', 'Ish'],
                    minute: ['', 'ear', 'toty', 'sig', 'ova', 'le', 'aa'],
                    meridian: ['', 'cher', 'per', 'ner', 'tor', 'te', 'ni']
                };
            }
            ...
            this.el.style.width = ((this.size + this.margin * 2) * setsLength) - this.margin + 'vw';
        ...
        HexaFlip.prototype._createCube = function (set) {
            ...
            cube.el.style.width = cube.el.style.height = this.size + 'vw';
            ...
            for (_j = 0, _len1 = faceNames.length; _j < _len1; _j++) {
                ...
                cube[side].style[css.transform] = "rotate3d(" + rotate3d + ") translate3d(0, 0, " + (this.size / 2) + "vw)";
        ...
        HexaFlip.prototype._getTransform = function (deg) {
            return "translateZ(-" + (this.size / 2) + "vw) rotateX(" + deg + "deg)";
        };
